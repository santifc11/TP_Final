...
public class Gestion {
    ...
    public void inicio_de_sesion() throws UsuarioNoExisteException, ContraseñaIncorrectaException{
        ...
        public void eliminar_Alojamiento(){
            String idONombre = "";
            System.out.println("Ingrese el Id o nombre del alojamiento:");
            idONombre = scanner.nextLine();

            for (Alojamiento a : Alojamientos){
                if (a.getId() == UUID.fromString(idONombre) || a.getNombre().compareTo(idONombre) == 0){
                    Alojamientos.remove(a);
